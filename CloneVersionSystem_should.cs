...
public class CloneVersionSystem_should
{
	...
	public void Learn()
	{
        ...
        ClassicAssert.AreEqual("45", clone1);
	}
	...
	public void RollbackToBasic()
	{
        ...
        ClassicAssert.AreEqual("basic", clone1);
	}
	...
	public void CloneBasic()
	{
        ...
        ClassicAssert.AreEqual("basic", clone2);
	}
	...
	public void CloneLearned()
	{
        ...
        ClassicAssert.AreEqual("42", clone2);
	}
	...
	public void LearnClone_DontChangeOriginal()
	{
        ...
        ClassicAssert.AreEqual(new []{ "42", "100500"}, res);
	}
	...
	public void RollbackClone_DontChangeOriginal()
	{
        ...
        ClassicAssert.AreEqual(new[] { "42", "basic" }, res);
	...
	public void ExecuteSample()
	{
		var res = Execute("learn 1 5",
			...
			"rollback 1",
			"check 1");
		ClassicAssert.AreEqual(new[] { "5", "7", "basic" }, res);
	}
